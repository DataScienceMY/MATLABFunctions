function FileDir = downloadGitHubFile(UserName, RepoName, FilePath, Optn)
% Downloads a file from a GitHub repo, even a private one. 
% Uses MATLAB built-in functions called webread and websave that rely on RESTful API.
% 
% Required arguments
...
FileDir = websave(FilePath, Data.download_url, Options);
end
